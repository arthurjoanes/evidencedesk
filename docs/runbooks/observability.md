...
Fontes desta seção, conferidas em **22/09/2026**: [observability.yaml](../../infra/compose/observability.yaml) · [check_observability.py](../../scripts/check_observability.py) · [observability-runtime-closed.json](../evidence/observability-runtime-closed.json).
...
Fontes desta seção, conferidas em **22/09/2026**: [observability-runtime.json](../evidence/observability-runtime.json) · [azure-smoke-trace.json](../evidence/azure-smoke-trace.json) · [alert-deliveries.json](../evidence/alert-deliveries.json).
...
Fontes desta seção, conferidas em **22/09/2026**: [observability-runtime-final.json](../evidence/observability-runtime-final.json) · [observability-final-attempt-1.json](../evidence/observability-final-attempt-1.json).
...
Fontes desta seção, conferidas em **22/09/2026**: [alert-recovery-worker-queue-collector.json](../evidence/alert-recovery-worker-queue-collector.json) · [alert-recovery-model.json](../evidence/alert-recovery-model.json) · [observability-runtime-closed.json](../evidence/observability-runtime-closed.json).
