...
Fontes desta seção, conferidas em **22/09/2026**: [retention/service.py](../../backend/src/evidencedesk/retention/service.py) · [cleanup.py](../../backend/src/evidencedesk/retention/cleanup.py) · [test_retention.py](../../backend/tests/integration/test_retention.py).
...
Fontes desta seção, conferidas em **22/09/2026**: [retention-integration.xml](../evidence/retention-integration.xml).
