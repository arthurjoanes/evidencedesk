...
Fontes desta seção, conferidas em **22/09/2026**: [package.json](package.json) · [rubric.json](rubric.json) · [metrics.py](../metrics.py).
...
Fontes desta seção, conferidas em **22/09/2026**: [package.json](package.json) · [dev.jsonl](../data/dev.jsonl) · [round.template.json](round.template.json).
...
Fontes desta seção, conferidas em **22/09/2026**: [rubric.json](rubric.json) · [response.template.json](response.template.json).
...
Fontes desta seção, conferidas em **22/09/2026**: [metrics.py](../metrics.py).
